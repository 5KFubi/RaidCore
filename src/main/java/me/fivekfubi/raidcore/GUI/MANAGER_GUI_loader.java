...
public class MANAGER_GUI_loader {
    ...
    public DATA_GUI getGData(String plugin_name, String path){
        Map<String, DATA_GUI> map = guis.get(plugin_name);
        if (map == null) return null;
        return map.get(path);
    }
    public String getSlotInGroup(int slot){
                ...
                for (String group_id : groups_section.getKeys(false)) {
                    ...
                    if (group_section != null){
                        ...
                        if (is_paged){
                            for (String page_key : group_section.getKeys(false)){
                                ...
                                if (items_section != null) {
                                    ...
                                    for (String item_id : items_section.getKeys(false)) {
                                        ...
                                        //
                                        GUI_Item gui_item = sectionToGItem(item_section, path_string, group_id, page_number, item_id, "gui", null);
                            ...
                            Map<String, GUI_Item> page_items = new HashMap<>();
                            //
                            GUI_Item gui_item = sectionToGItem(group_section, path_string, group_id, page_number, group_id, "gui", null);
                            List<Integer> slots = gui_item.slots;
                            used_slots.addAll(slots);
                            group_slot.put(slots, group_id);
        ...
        try {
            ...
            if (v_section != null) {
                for (String var_id : v_section.getKeys(false)) {
                    ...
                    GUI_Item variation = sectionToGItem(section, path_string, group_id, page_number, item_id, variant, var_id);
